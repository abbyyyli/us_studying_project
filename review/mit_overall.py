...
# 設定基礎參數
base_url = "https://www.niche.com/colleges/massachusetts-institute-of-technology/reviews/"
headers = {
    "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.199 Safari/537.36"
}
output_file = "mit_reviews_overall_experience.csv"  # 儲存爬取結果的檔案
data = []  # 用來儲存所有評論資料
university_name = "MIT University"  # 固定的學校名稱

# 爬取多頁評論
for page in range(1, 13):  # 設定頁數範圍，根據需求調整
    print(f"正在爬取第 {page} 頁...")
    url = f"{base_url}?page={page}&category=Overall-Experience"
    try:
